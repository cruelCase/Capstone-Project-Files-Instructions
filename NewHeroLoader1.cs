...
public class NewHeroLoader1 : MonoBehaviour
{
    ...
    public void LoadHero()
    {
        ...
        {
            string dialogue =
                "Maligayang pagdating sa iyong pangalawang Pagsubok! " +
                "Lahat ng mga tanong dito ay mula sa pangalawang mundo na paksa. " +
                "Galingan mo!";
