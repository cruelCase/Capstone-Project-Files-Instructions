...
public class MinigameChecker : MonoBehaviour
{
    ...
    public void LoadMainQuizSceneForActiveUser()
    {
        ...
        {
            Debug.LogWarning("MinigameChecker: Active user has not met the requirements for any main quiz scene.");
            ShowBlockedPanel();
            return;
        }
    ...
    private ProfilePlayerData GetActiveUserProfile()
    {
        ...
        {
            Debug.LogError("MinigameChecker: No active user found. Cannot load main quiz scene.");
            ShowBlockedPanel();
            return null;
        }
        ...
        if (!File.Exists(path))
        {
            Debug.LogError($"MinigameChecker: Profile file not found for user '{activeUser}'. Cannot load main quiz scene.");
            ShowBlockedPanel();
            return null;
        }
        ...
        if (profile == null)
        {
            Debug.LogError("MinigameChecker: Failed to parse profile JSON. Cannot load main quiz scene.");
            ShowBlockedPanel();
            return null;
        }
    ...
    private void ShowBlockedPanel()
    {
        ...
        {
            Debug.LogWarning("MinigameChecker: blockedPanel is not assigned in the inspector.");
            return;
        }
