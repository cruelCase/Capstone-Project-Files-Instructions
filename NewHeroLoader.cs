...
public class NewHeroLoader : MonoBehaviour
{
    ...
    public void LoadHero()
    {
        ...
        {
            string dialogue =
                "Maligayang pagdating sa iyong unang MainQuiz! " +
                "Dito mo maipapakita kung ano ang natutunan mo mula sa unang mundo. " +
                "Pagkatapos nito, maaari kang magpatuloy sa ibang paksa sa susunod na mundo. " +
                "Good luck!";
